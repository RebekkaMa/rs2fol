...
import interface_adapters.services.theoremProver.TheoremProverRunnerError
...
import use_cases.commands.subUseCase.GetTheoremProverCommandError
import use_cases.commands.subUseCase.TPTPTupleAnswerModelToN3SUseCaseError
import use_cases.modelToString.LiteralTransformationError
import use_cases.modelTransformer.FOLGeneralTermToRDFSurfaceUseCaseError
...
object ErrorToStringTransformer {
    ...
    operator fun invoke(error: RootError): String {
        return TextStyler.error("Error: ") + when (error) {
            ...
            is TPTPTupleAnswerModelToN3SUseCaseError.InvalidInputError -> {
