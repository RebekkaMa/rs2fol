...
class RDFSurfacesParserTest : ShouldSpec(
    {
        context("selected Turtle examples") {
            should("transform example2.n3 without exception") {
                ...
                RDFSurfacesParser(false).parseToEnd(
                    file.readText(),
                    IRI.from("file://" + file.absolute().parent.invariantSeparatorsPathString + "/")
                ) shouldBeEqualToComparingFields PositiveSurface(
                    listOf(),
                    listOf(rdfTriple)
                )
            }
            ...
            should("transform example3.n3 without exception") {
                ...
                val literal = DefaultLiteral("Spiderman", XSDDatatype.XSDstring)
            ...
            should("transform example5.n3 without exception") {
                ...
                val literal1 = DefaultLiteral("Spiderman", XSDDatatype.XSDstring)
            ...
            should("transform example10.n3 without exception") {
                ...
                val literal1 = DefaultLiteral("Green Goblin", XSDDatatype.XSDstring)
                val literal2 = DefaultLiteral("Spiderman", XSDDatatype.XSDstring)
            ...
            should("transform example12.n3 without exception") {
                ...
                val literal1 = DefaultLiteral(2, XSDDatatype.XSDinteger)
                val literal2 = DefaultLiteral(
                    XSDDatatype.XSDdecimal.parse("4.002602"),
                    XSDDatatype.XSDdecimal
                )
                val literal3 = DefaultLiteral(1.663E-4, XSDDatatype.XSDdouble)
            ...
            should("transform example13.n3 without exception") {
                ...
                val literal1 = DefaultLiteral(false, XSDDatatype.XSDboolean)
            ...
            should("transform example15.n3 without exception") {
                ...
                val literal = DefaultLiteral("Bob", XSDDatatype.XSDstring)
            ...
            should("transform example16.n3 without exception") {
                ...
                val literal1 = DefaultLiteral("Alice", XSDDatatype.XSDstring)
                val literal2 = DefaultLiteral("Bob", XSDDatatype.XSDstring)
                val literal3 = DefaultLiteral("Eve", XSDDatatype.XSDstring)
        ...
        context("case insensitive base") {
            should("accept case insensitive 'base' and 'prefix'") {
                ...
                val literal = DefaultLiteral.fromNonNumericLiteral("base", IRI.from(IRIConstants.XSD_STRING_IRI))

                rdfSurfaceParser.parseToEnd(
                    testStr,
                    IRI.from("file://" + IRI.from(System.getProperty("user.dir")))
                ) shouldBeEqualToComparingFields PositiveSurface(listOf(), listOf(RdfTriple(iri1, iri2, literal)))
            }
        }
