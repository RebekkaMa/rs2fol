fof(axiom,axiom,
   triple('http://one.example/subject1','http://one.example/predicate1','http://one.example/object1')
   & triple('http://one.example/subject2','http://one.example/predicate2','http://one.example/object2')
   & triple('http://one.example/subject2','http://one.example/predicate2','http://one.example/object2')
   & triple('http://two.example/subject3','http://two.example/predicate3','http://two.example/object3')
   & triple('http://two.example/subject3','http://two.example/predicate3','http://two.example/object3')
